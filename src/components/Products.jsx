...
import pana from '/src/assets/pana.svg'
import Maecenas from '../assets/product11.svg'
    ...
    <div>
            ...
            <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-8' id='product'>
                <div className='md:w-11/12 mx-auto flex flex-col md:flex-row justify-between items-center gap-12'>
                    <div >
                        <img src={pana} alt="" className='h-80 w-80' />
                    </div>
            ...
            <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto bg-neutralSilver py-16'>
                <div className='flex flex-col md:flex-row justify-between items-center gap-8'>
                    <div className='md:w-1/3'>
                        <img src={Maecenas} alt="" className='h-80 w-80'/>
                    </div>
                    ...
                    <div className='md:w-2/3 mx-auto'>
                        <div>
                            ...
                            <div className='text-base text-neutralGrey mb-8'>
                                <div className='flex items-center gap-8 flex-wrap'>
                                    ...
                                    <img src="/src/assets/icons/company7.svg" alt="" className='cursor-pointer' />
                                    <div className='flex items-center gap-8'>
                                        <a href="/" className='font-bold text-brandPrimary hover:text-neutral-700 flex itmes-center'>Meet all customers <img src="/src/assets/right.svg" alt="" className='h-6 w-6' /></a>
                                    </div>
                                </div>
                            </div>
                        </div>
